...
<template id="success-toast-template">
    <div class="toast-item flex items-center p-4 mb-4 text-green-500 bg-white rounded-lg shadow-lg border-l-4 border-green-500 dark:text-green-400 dark:bg-gray-800 transform transition-all duration-300 ease-in-out translate-x-full opacity-0">
...
<template id="error-toast-template">
    <div class="toast-item flex items-center p-4 mb-4 text-red-500 bg-white rounded-lg shadow-lg border-l-4 border-red-500 dark:text-red-400 dark:bg-gray-800 transform transition-all duration-300 ease-in-out translate-x-full opacity-0">
...
<template id="info-toast-template">
    <div class="toast-item flex items-center p-4 mb-4 text-blue-500 bg-white rounded-lg shadow-lg border-l-4 border-blue-500 dark:text-blue-400 dark:bg-gray-800 transform transition-all duration-300 ease-in-out translate-x-full opacity-0">
