<x-seller.app>
    <div x-data="martProfile">
        ...
        <div class="pt-5 space-y-8 ">
            ...
            <div
                class="relative p-8 overflow-hidden text-white rounded-xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600">
                <!-- Banner Background -->
                @if ($mart->banner_url)
                    <div class="absolute inset-0">
                        <img src="{{ asset('storage/' . $mart->banner_url) }}" alt="Banner {{ $mart->name }}"
                ...
                <div class="relative z-10 flex flex-col items-center gap-8 lg:flex-row">
                    <!-- Mart Profile Picture -->
                    <div class="relative group">
                        <div
                            class="w-32 h-32 overflow-hidden transition-transform duration-300 border-4 rounded-full shadow-xl lg:w-40 lg:h-40 border-white/20 group-hover:scale-105">
                            @if ($user->profile_pic)
                                <img src="{{ asset('storage/' . $user->profile_pic) }}" alt="{{ $mart->name }}"
                                    class="object-cover w-full h-full" />
                            @else
                                <div
                                    class="flex items-center justify-center w-full h-full bg-gradient-to-br from-white/20 to-white/10">
                        ...
                        <div class="absolute -bottom-2 -right-2">
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $mart->is_active ? 'bg-green-500 text-white' : 'bg-red-500 text-white' }}">
                                <div
                                    class="w-2 h-2 rounded-full {{ $mart->is_active ? 'bg-green-200' : 'bg-red-200' }} mr-1 animate-pulse">
                                </div>
                    ...
                    <div class="flex-1 text-center lg:text-left">
                        <h1 class="mb-2 text-3xl font-bold text-white lg:text-4xl drop-shadow-lg">
                            {{ $mart->name ?? 'Your Mart Name' }}
                        </h1>
                        <p class="mb-4 text-lg text-white/90 drop-shadow">
                            {{ $mart->martCategory->name ?? 'General Category' }}
                        </p>
                        <p class="max-w-2xl mb-6 leading-relaxed text-white/80 drop-shadow">
                        ...
                        <div class="flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
                            <a href="{{ route('seller.mart.show') }}"
                                class="inline-flex items-center px-6 py-3 font-semibold text-purple-600 transition-colors duration-200 bg-white rounded-lg shadow-lg hover:bg-white/90">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                <!-- Total Products -->
                <div class="p-6 transition-shadow duration-300 border-l-4 border-blue-500 panel hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="mb-1 text-sm text-gray-600 dark:text-gray-400">Total Products</p>
                ...
                <!-- Total Services -->
                <div class="p-6 transition-shadow duration-300 border-l-4 border-green-500 panel hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <!-- Total Orders -->
                <div class="p-6 transition-shadow duration-300 border-l-4 border-yellow-500 panel hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <!-- Rating -->
                <div class="p-6 transition-shadow duration-300 border-l-4 border-purple-500 panel hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2">
                    <div class="p-6 panel">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span
                                class="text-xs px-3 py-1 rounded-full {{ $mart->is_active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' }}">
                                {{ $mart->is_active ? 'Active' : 'Inactive' }}
                            </span>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start gap-4">
                                <div
                                    class="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-lg dark:bg-blue-900/30 shrink-0">
                            ...
                            <div class="flex items-start gap-4">
                                <div
                                    class="flex items-center justify-center w-10 h-10 bg-green-100 rounded-lg dark:bg-green-900/30 shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">
                                        {{ $mart->martCategory->name ?? 'General Category' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                <div
                                    class="flex items-center justify-center w-10 h-10 bg-purple-100 rounded-lg dark:bg-purple-900/30 shrink-0">
                            ...
                            <div class="flex items-start gap-4">
                                <div
                                    class="flex items-center justify-center w-10 h-10 bg-yellow-100 rounded-lg dark:bg-yellow-900/30 shrink-0">
                                    <svg class="w-5 h-5 text-yellow-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V3m6 4v4M3 18h18M3 14h18M3 10h18M3 6h18" />
                                    </svg>
                                </div>
                                <div>
                                    <h3 class="font-semibold text-gray-900 dark:text-white">Created Date</h3>
                                    <p class="text-gray-600 dark:text-gray-400">
                                        {{ $mart->created_at->format('F d, Y') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6 panel">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('seller.profile.show') }}" class="text-sm text-primary hover:underline">
                            Edit Profile
                        </a>
                    </div>
                    ...
                    <div class="mb-6 text-center">
                        <div
                            ...
                            @else
                                <div
                                    class="flex items-center justify-center w-full h-full bg-gradient-to-br from-blue-400 to-purple-500">
                                    <span
                                        class="text-xl font-bold text-white">{{ strtoupper(substr($mart->user->name, 0, 1)) }}</span>
                                </div>
                            @endif
                        </div>
                        <h3 class="text-lg font-semibold">{{ $mart->user->name }}</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">{{ $mart->user->email }}</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V3m6 4v.01M3 21h18M3 10h18M7 3h10" />
                            </svg>
            ...
            <!-- Quick Actions -->
            <div class="p-6 panel ">
                <h2 class="mb-6 text-xl font-semibold">Quick Actions</h2>
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <a href="{{ route('seller.product.create') }}"
                        class="flex items-center gap-3 p-4 transition-colors duration-200 rounded-lg bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30">
                    ...
                    <a href="{{ route('seller.service.create') }}"
                        class="flex items-center gap-3 p-4 transition-colors duration-200 rounded-lg bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30">
                    ...
                    <a href=""
                        class="flex items-center gap-3 p-4 transition-colors duration-200 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 hover:bg-yellow-100 dark:hover:bg-yellow-900/30">
