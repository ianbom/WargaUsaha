    ...
    <div x-data="form">
        <div class="flex items-center justify-between ">
            ...
            <nav class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span class="text-gray-800">Create Job</span>
            </nav>
        </div>
        <div class="pt-5">
            <!-- Create Job Form -->
            <div class="panel">
                <div class="flex items-center justify-between mb-5">
                    <h5 class="text-lg font-semibold dark:text-white-light">Create New Job</h5>
                </div>
                ...
                @endif
                <div class="mb-5">
                    <form action="{{ route('employer.job.store') }}" method="POST" enctype="multipart/form-data"
                        class="space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="job_description" name="job_description" rows="4" placeholder="Enter Job Description"
                                class="form-input @error('job_description') border-red-500 @enderror" required>{{ old('job_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="skill_requirement" name="skill_requirement" rows="4" placeholder="Enter Skill Requirement"
                                class="form-input @error('skill_requirement') border-red-500 @enderror" required>{{ old('skill_requirement') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="location_detail" name="location_detail" rows="4" placeholder="Enter Detail Detail"
                                class="form-input @error('location_detail') border-red-500 @enderror" required>{{ old('location_detail') }}</textarea>
