                    ...
                    <ul>
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'invoice'" x-collapse
                                ...
                                <li>
                                    <a href="/admin/mart">All Mart</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.mart.registration') }}">Registration</a>
                                </li>
                         ...
                         <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">User</span>
                                </div>
                            ...
                            <ul x-cloak x-show="activeDropdown === 'user'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="/admin/user">All User</a>
                                </li>
                                {{-- <li>
                                    <a href="/admim/registration/user">Registration</a>
                                </li> --}}

                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/service" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/admin/transaction" class="group">
                                <div class="flex items-center">
