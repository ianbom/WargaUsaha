    ...
    <div x-data="auth">
        ...
        <div
            ...
            <div
                ...
                <div
                    class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(147,197,253,1)_0%,rgba(181,165,250,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                    <div
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-5 dark:text-white">
                            ...
                            <div>
                                ...
                                @error('email')
                                    <p class="mt-1 text-xs text-red-600 bg-red-100">* {{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                        ...
                        <div class="space-y-2 text-center dark:text-white">
                            <div>
                                Belum punya akun?
                                <a href="{{ route('register') }}"
                                    class="font-bold transition text-primary hover:text-black dark:hover:text-white">
                                    Sign Up
                                </a>
                            </div>
                            <div>
